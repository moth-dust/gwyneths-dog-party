...
li {
  ...
  flex-direction: column;
  align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/css/index.scss","webpack://./src/css/_variables.scss"],"names":[],"mappings":"AACA;EACE,wBAAA;EACA,kBAAA;EACA,uBAAA;AAAF;;AAGA;EACE,gEAAA;EACA,aAAA;EACA,WAAA;AAAF;;AAGA;EAEE,yBCduB;ADazB;;AAIA;EACE,WAAA;AADF;;AAGA;EACE,kBAAA;EACA,mBAAA;EACA,iBAAA;EACA,iCAAA;EACA,wBAAA;AAAF;;AAEA;EACE,8BAAA;EACA,6BAAA;AACF;;AAGA;EACE,sBAAA;EACA,aAAA;EAEA,iBAAA;EACA,WAAA;EACA,aAAA;EACA,mBAAA;AADF;;AAIA;EACE,qBAAA;EACA,aAAA;EACA,6BAAA;AADF;;AAGA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AAAF","sourcesContent":["@import 'variables';\n:root{\n  --main-image-size: 300px;\n  --li-images: 200px;\n  --border-color: #3F8DA8;\n}\n\nbody {\n  background: url('../../dist/images/park.jpg') center/cover;\n  height: 100vh;\n  width: 100%;\n}\n\nnav {\n  // Example of using a variable:\n  background-color: $secondary-accent-color;\n}\n\n.dog-icon {\n  width: 50px;\n}\n.doggie{\n  border-radius: 50%;\n  border-style: solid;\n  border-width: 4px;\n  border-color: var(--border-color);\n  height: var(--li-images);\n}\n.large{\n  height: var(--main-image-size);\n  width: var(--main-image-size);\n  \n}\n\nfigure{\n  flex-direction: column;\n  margin: 90\n  px;\n  max-height: 495px;\n  width: auto;\n  display: flex;\n  align-items: center;\n}\n\narticle > ul {\n  list-style-type: none;\n  display: flex;\n  justify-content: space-around;\n}\nli{\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n","$main-accent-color: #3F8DA8;\n$secondary-accent-color: #92E0E5;\n@mixin dog-bubble($image){\n    image: $image;\n    image{\n        border-radius: 50%;\n    }\n    \n}"],"sourceRoot":""}]);
// Exports
